...
async function loadHome() {
  const banners = await getSortedItems('../server/banners/index.get.json');
  ...
  const categories = await getSortedItems('../server/categories/index.get.json');
...
async function loadProducts() {
  const products = await fetchItemsByUrl('../server/products/index.get.json');
